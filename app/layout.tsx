...
export const metadata = {
  title: 'Movoo Docs',
  description: 'Movoo Docs is a comprehensive documentation for the Movoo platform, providing insights, tutorials, and best practices to help you build, manage, and optimize your Movoo applications.',
}
